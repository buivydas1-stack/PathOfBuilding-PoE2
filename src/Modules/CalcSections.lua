...
{ 1, "Crit", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Crits", data = {
	...
	{ label = "MH Crit Bifurcates", bgCol = colorCodes.MAINHANDBG, haveOutput = "MainHand.CritBifurcates", flag = "weapon1Attack", { format = "x {2:output:MainHand.CritBifurcates}", 
	...
	{ label = "OH Crit Bifurcates", bgCol = colorCodes.OFFHANDBG, haveOutput = "OffHand.CritBifurcates", flag = "weapon2Attack", { format = "x {2:output:OffHand.CritBifurcates}", 
...
{ 1, "SkillTypeStats", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Skill type-specific Stats", data = {
	...
	{ label = "Avg. Projectile Count", flag = "projectile", { format = "{2:output:ProjectileCount}", { modName = { "NoAdditionalProjectiles" , "ProjectileCount", "SurpassingProjectileChance", "TwoAdditionalProjectilesChance" }, cfg = "skill" }, }, },
	{ label = "Surpassing Proj. Chance", flag = "projectile", { format = "{2:output:SurpassingProjectileChance}%", { label = "Chance total (not capped at 100%; projectile restrictions still apply)", modName = "SurpassingProjectileChance", cfg = "skill" }, }, },
