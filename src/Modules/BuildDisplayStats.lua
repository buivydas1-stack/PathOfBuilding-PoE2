...
local displayStats = {
	...
	{ compareSection = "Ailments", stat = "ShockChance", label = "Shock Chance", fmt = ".2f%%", flag = "hit" },
	{ stat = "ElectrocuteBuildupAvg", label = "Electrocute Buildup", fmt = ".2f%%", compPercent = true, flag = "hit" },
	{ compareSection = "Damage", stat = "HitChance", label = "Hit Chance", fmt = ".0f%%", condFunc = function(v,o) return o.enemyHasSpellBlock end },
