...
-- compareSection starts an inherited tooltip category; compareCategory overrides
-- a single row. Neither changes the sidebar's ordering or formatting.


local displayStats = {
	{ compareSection = "Damage", stat = "ActiveMinionLimit", label = "Active Minion Limit", fmt = "d" },
	...
	{ stat = "Speed", label = "Attack Rate", fmt = ".2f", compPercent = true, flag = "attack", condFunc = function(v,o) return v > 0 and not o.ChannelTime and (o.TriggerTime or 0) == 0 end },
	{ stat = "Speed", label = "Cast Rate", fmt = ".2f", compPercent = true, flag = "spell", condFunc = function(v,o) return v > 0 and not o.ChannelTime and (o.TriggerTime or 0) == 0 end },
	...
	{ stat = "PreEffectiveCritChance", label = "Crit Chance", compareBeforeAfter = true, fmt = ".2f%%", flag = "hit" },
	{ stat = "CritChance", label = "Effective Crit Chance", compareBeforeAfter = true, fmt = ".2f%%", flag = "hit", condFunc = function(v,o) return v ~= o.PreEffectiveCritChance end },
	{ stat = "CritBifurcates", label = "Crit Bifurcate Chance", compareBeforeAfter = true, fmt = ".2f%%", flag = "hit", condFunc = function(v,o) return (o.CritForks or 0) > 0 end },
	{ stat = "CritMultiplier", label = "Crit Multiplier", fmt = "d%%", pc = true, condFunc = function(v,o) return (o.CritChance or 0) > 0 end },
	{ stat = "HitChance", label = "Hit Chance", compareBeforeAfter = true, fmt = ".0f%%", flag = "attack" },
	{ compareSection = "Ailments", stat = "ShockChance", label = "Shock Chance", compareBeforeAfter = true, fmt = ".2f%%", flag = "hit" },
	{ stat = "ElectrocuteBuildupAvg", label = "Electrocute Buildup", compareBeforeAfter = true, fmt = ".2f%%", compPercent = true, flag = "hit" },
	{ compareSection = "Damage", stat = "HitChance", label = "Hit Chance", compareBeforeAfter = true, fmt = ".0f%%", condFunc = function(v,o) return o.enemyHasSpellBlock end },
	{ stat = "AccuracyHitChanceUncapped", label = "Uncap. Hit Chance", compareBeforeAfter = true, fmt = ".0f%%", flag = "attack", condFunc = function(v,o) if o.AccuracyHitChanceUncapped then return o.AccuracyHitChanceUncapped > 100 end end },
	...
	{ stat = "ExplodeChance", label = "Total Explode Chance", compareBeforeAfter = true, fmt = ".0f%%" },
	...
	{ compareSection = "Utility", stat = "ManaCost", label = "Mana Cost", fmt = "d", color = colorCodes.MANA, pool = "ManaUnreserved", compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.ManaHasCost end },
	...
	{ },
	{ compareSection = "Survivability", stat = "TotalEHP", label = "Effective Hit Pool", fmt = ".0f", compPercent = true },
	...
	{ },
	{ compareSection = "Utility", stat = "Mana", label = "Total Mana", fmt = "d", color = colorCodes.MANA, compPercent = true },
	...
	{ },
	{ compareSection = "Survivability", stat = "EnergyShield", label = "Energy Shield", fmt = "d", color = colorCodes.ES, compPercent = true },
	...
	{ },
	{ compareSection = "Utility", stat = "Rage", label = "Rage", fmt = "d", color = colorCodes.RAGE, compPercent = true },
	{ stat = "RageRegenRecovery", label = "Rage Regen", fmt = ".1f", color = colorCodes.RAGE, compPercent = true },
	{ },
	{ compareSection = "Survivability", stat = "TotalBuildDegen", label = "Total Degen", fmt = ".1f", lowerIsBetter = true },
	{ stat = "TotalNetRegen", label = "Total Net Recovery", fmt = "+.1f" },
	{ stat = "NetLifeRegen", label = "Net Life Recovery", fmt = "+.1f", color = colorCodes.LIFE },
	{ compareCategory = "Utility", stat = "NetManaRegen", label = "Net Mana Recovery", fmt = "+.1f", color = colorCodes.MANA },
	...
	{ stat = "EvadeChance", label = "Evade Chance", compareBeforeAfter = true, fmt = "d%%", color = colorCodes.EVASION, condFunc = function(v,o) return v > 0 and o.noSplitEvade end },
	{ stat = "MeleeEvadeChance", label = "Melee Evade Chance", compareBeforeAfter = true, fmt = "d%%", color = colorCodes.EVASION, condFunc = function(v,o) return v > 0 and o.splitEvade end },
	{ stat = "ProjectileEvadeChance", label = "Projectile Evade Chance", compareBeforeAfter = true, fmt = "d%%", color = colorCodes.EVASION, condFunc = function(v,o) return v > 0 and o.splitEvade end },
	{ stat = "SpellEvadeChance", label = "Spell Evade Chance", compareBeforeAfter = true, fmt = "d%%", color = colorCodes.EVASION, condFunc = function(v,o) return v > 0 and o.splitEvade end },
	{ stat = "SpellProjectileEvadeChance", label = "Spell Proj. Evade Chance", compareBeforeAfter = true, fmt = "d%%", color = colorCodes.EVASION, condFunc = function(v,o) return v > 0 and o.splitEvade end },
	{ stat = "DeflectionRating", label = "Deflection Rating", fmt = "d", color = colorCodes.EVASION, compPercent = true },
	{ stat = "DeflectChance", label = "Deflect Chance", compareBeforeAfter = true, fmt = "d%%", color = colorCodes.EVASION, compPercent = true },
	{ },
	...
	{ },
	{ stat = "EffectiveBlockChance", label = "Block Chance", compareBeforeAfter = true, fmt = "d%%", overCapStat = "BlockChanceOverCap" },
	{ stat = "EffectiveSpellBlockChance", label = "Spell Block Chance", compareBeforeAfter = true, fmt = "d%%", overCapStat = "SpellBlockChanceOverCap" },
	{ stat = "AttackDodgeChance", label = "Attack Dodge Chance", compareBeforeAfter = true, fmt = "d%%", overCapStat = "AttackDodgeChanceOverCap" },
	{ stat = "SpellDodgeChance", label = "Spell Dodge Chance", compareBeforeAfter = true, fmt = "d%%", overCapStat = "SpellDodgeChanceOverCap" },
	{ stat = "EffectiveSpellSuppressionChance", label = "Spell Suppression Chance", compareBeforeAfter = true, fmt = "d%%", overCapStat = "SpellSuppressionChanceOverCap" },
	{ },
	...
	{ },
	{ compareSection = "Utility", stat = "EffectiveMovementSpeedMod", label = "Movement Speed Modifier", fmt = "+.1f%%", mod = true, condFunc = function() return true end },
	...
	--]]
	{ },
	{ compareSection = "Damage", stat = "FullDPS", label = "Full DPS", fmt = ".1f", color = colorCodes.CURRENCY, compPercent = true },
...
local minionDisplayStats = {
	{ compareSection = "Damage", stat = "AverageDamage", label = "Average Damage", fmt = ".1f", compPercent = true },
	...
	{ stat = "Cooldown", label = "Skill Cooldown", fmt = ".3fs", lowerIsBetter = true },
	{ compareSection = "Survivability", stat = "Life", label = "Total Life", fmt = ".1f", color = colorCodes.LIFE, compPercent = true },
